...
let expReg2 = new RegExp("javascript","ig");
    /* La bandera g no solo se queda con primera coincidencia sino con todas */

let expReg3 = /javascript/ig;

let expReg4 = /\d/ig // \d - busca un numero
let expReg5 = /[0-9]/ig // \[] - busca un numero en un rango determinado
let expReg6 = /javascript{1}/ig;//al menos la palabra javascript se tiene que repetir 1 vez.
let expReg7 = /javascript{3}/ig;//al menos la palabra javascript se tiene que repetir 3 veces.
